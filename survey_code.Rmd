...
;2. Supervision;3. Resources;4. Mental Well-being and Support;5. Professional Development and Job Market;6. Feedback and Suggestions.We designed questions in these six aspects and collected feedback from students and analyse them.
...
Overall, students were satisfied with their academic experience, with only one aspect lower than expected.While students are able to gain constructive input from their dialogue with faculties, they struggled to gain the breadth and depth of knowledge from the courses offered by the department.
...
It is evident that students' dissatisfaction is mainly centred on the quantity and quality of the courses, while they are more satisfied with the relationship with faculties and the academic atmosphere.
...
Overall, students were satisfied with their supervision. For every aspect of supervision, the average student satisfaction rating exceeded "Mostly agree". In comparison, students were most satisfied with " " and slightly less satisfied with " ".
...
For each question, we set five options, which included "Definitely disagree", "Mostly disagree", "Neither agree nor disagree", "Mostly agree", "Definitely agree". For each question, we counted the frequency of occurrence of each option.
It is evident that students have little to no dissatisfaction with every aspect of the supervision. More students expressed "Definitely agree" for "", while more students expressed "Mostly agree" for "".
...
Overall, students were satisfied with their resources For every aspect of supervision, the average student satisfaction rating exceeded "Mostly agree". In comparison, students were most satisfied with " " and slightly less satisfied with " ".
